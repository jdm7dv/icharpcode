...
namespace ICSharpCode.TextEditor.Document
{
	...
	{
		bool      didRead = false;
		IDocumentAggregator curDocument = null;
		...
		public ProvidedDocumentInformation Current {
			get {
				...
				curDocument = (((ITextAreaControlProvider)WorkbenchSingleton.Workbench.ActiveWorkbenchWindow.ViewContent).TextAreaControl).Document;
