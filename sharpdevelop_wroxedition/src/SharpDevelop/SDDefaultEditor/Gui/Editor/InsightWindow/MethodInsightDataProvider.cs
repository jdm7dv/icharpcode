...
namespace ICSharpCode.SharpDevelop.DefaultEditor.Gui.Editor
{
	public class MethodInsightDataProvider : IInsightDataProvider
	{
		...
		public void SetupDataProvider(string fileName, IDocumentAggregator document)
		{
			...
			caretColumn          = document.Caret.Offset - document.GetLineSegment(caretLineNumber).Offset + 1;
			...
			ResolveResult results = parserService.Resolve(methodObject, caretLineNumber, caretColumn, fileName);
