...
namespace ICSharpCode.Core.AddIns
{
	...
	public class AddInTreeSingleton : DefaultAddInTree
	{
		...
		readonly static string defaultCoreDirectory = Application.StartupPath + 
		...
		static void CreateAddInTree()
		{
			...
			StringCollection addInFiles = fileUtilityService.SearchDirectory(defaultCoreDirectory, "*.addin");
			StringCollection retryList  = InsertAddIns(addInFiles);
