...
namespace ICSharpCode.TextEditor.Document
{
	public sealed class TextUtilities
	{
		...
		/// </summary>
		public static string GetExpressionBeforeOffset(IDocumentAggregator document, int offset)
		{
			int bracketCount = 0;
			
			while (offset > 0 && document.GetCharAt(offset - 1) != '}'  &&
			...
			return document.GetText(offset, document.Caret.Offset - offset).Trim();
		}
		...
		public static int GetFirstNonWSChar(IDocumentAggregator document, int offset)
		{
		...
		public static int FindWordEnd(IDocumentAggregator document, int offset)
		{
		...
		public static int FindWordStart(IDocumentAggregator document, int offset)
		{
			LineSegment line = document.GetLineSegmentForOffset(offset);
		...
		// next word
		public static int FindNextWordStart(IDocumentAggregator document, int offset)
		{
		...
		public static int FindPrevWordStart(IDocumentAggregator document, int offset)
		{
			int originalOffset = offset;
			LineSegment line = document.GetLineSegmentForOffset(offset);
			if (offset > 0) {
		...
		public static string GetLineAsString(IDocumentAggregator document, int lineNumber)
		{
			LineSegment line = document.GetLineSegment(lineNumber);
			return document.GetText(line.Offset, line.Length);
		}
		
		static bool ScanLineComment(IDocumentAggregator document, int offset)
		{
		...
		public static int SearchBracketBackward(IDocumentAggregator document, int offset, char openBracket, char closingBracket)
		{
			int brackets = -1;
		...
		public static int SearchBracketForward(IDocumentAggregator document, int offset, char openBracket, char closingBracket)
		{
			int brackets = 1;
		...
		/// </summary>
		public static bool IsEmptyLine(IDocumentAggregator document, int lineNumber)
		{
		...
		/// Returns true, if the line lineNumber is empty or filled with whitespaces.
		/// </summary>
		public static bool IsEmptyLine(IDocumentAggregator document, LineSegment line)
		{
