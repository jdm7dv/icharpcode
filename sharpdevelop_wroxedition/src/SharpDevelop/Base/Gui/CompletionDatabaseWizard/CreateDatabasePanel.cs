	...
	public class CreateDatabasePanel : AbstractWizardPanel, IProgressMonitor
	{
		...
		void StartCreation(object sender, EventArgs e)
		{
			...
			if (generateThread != null) {
				...
				generateThread.Priority = ThreadPriority.BelowNormal;
		...
		public CreateDatabasePanel() : base(Application.StartupPath + @"\..\data\resources\panels\CompletionDatabaseWizard\ViewProgressPanel.xfrm")
		{
