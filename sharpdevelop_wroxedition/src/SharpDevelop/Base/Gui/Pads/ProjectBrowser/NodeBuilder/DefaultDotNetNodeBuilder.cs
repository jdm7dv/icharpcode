...
namespace ICSharpCode.SharpDevelop.Gui.Pads.ProjectBrowser
{
	public class DefaultDotNetNodeBuilder : IProjectNodeBuilder
	{
		...
		public AbstractBrowserNode BuildProjectTreeNode(IProject project)
		{
			...
			projectNode.IconImage = fileUtilityService.GetImageForProjectType(project.ProjectType);
			
			FolderNode resourceNode = new NamedFolderNode("ProjectComponent.ResourceFilesString");
			...
			FolderNode referenceNode = new NamedFolderNode("ProjectComponent.ReferencesString");
