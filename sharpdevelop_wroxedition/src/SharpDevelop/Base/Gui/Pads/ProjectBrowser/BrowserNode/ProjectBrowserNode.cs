		...
		public override void AfterLabelEdit(string newName)
		{
			if (newName != null && newName.Trim().Length > 0 && newName != project.Name) {
				...
				try {
					...
					MessageBox.Show("Exception while changing the name of the project " + project.Name + "\n got :" + e.ToString(), "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
				}
			}
		}
