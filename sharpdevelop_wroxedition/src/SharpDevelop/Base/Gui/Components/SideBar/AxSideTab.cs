...
namespace ICSharpCode.SharpDevelop.Gui.Components
{
	...
	public class AxSideTab
	{
		...
		public AxSideTab(AxSideBar sideBar)
		{
			items = new SideTabItemCollection(sideBar);
		}
		
		public AxSideTab(AxSideBar sideBar, string name) : this(sideBar)
		{
			this.name = name;
		}
		...
		public class SideTabItemCollection : ICollection, IEnumerable
		{
			...
			public SideTabItemCollection(AxSideBar sideBar)
			{
			...
			{
				AxSideTabItem item = sideBar.SideTabItemFactory.CreateSideTabItem(name, imageIndex);
				item.Tag = content;
				return Add(item);
			}
