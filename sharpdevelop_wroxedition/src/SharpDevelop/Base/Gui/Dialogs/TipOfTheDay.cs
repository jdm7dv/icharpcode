...
namespace ICSharpCode.SharpDevelop.Gui.Dialogs
{
	...
	public class TipOfTheDayDialog : Form
	{
		...
		private void InitializeComponent()
		{
			...
			closeButton.FlatStyle = flat ? FlatStyle.Flat : FlatStyle.Standard;
			...
			viewTipsAtStartCheckBox.FlatStyle = flat ? FlatStyle.Flat : FlatStyle.Standard;
			...
			nextTipButton.FlatStyle = flat ? FlatStyle.Flat : FlatStyle.Standard;
