...
namespace ICSharpCode.SharpDevelop.Gui.Dialogs
{
	...
	public class WizardDialog : System.Windows.Forms.Form
	{
		...
		void InitializeComponents()
		{
			...
			int buttonXStart = Width - ((buttonSize + 4) * 5) - 4;
			...
			backButton.FlatStyle = flat ? FlatStyle.Flat : FlatStyle.Standard;
			...
			nextButton.FlatStyle = flat ? FlatStyle.Flat : FlatStyle.Standard;
			...
			finishButton.FlatStyle = flat ? FlatStyle.Flat : FlatStyle.Standard;
