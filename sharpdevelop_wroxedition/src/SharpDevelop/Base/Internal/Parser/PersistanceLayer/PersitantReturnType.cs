...
{
	public sealed class PersistantReturnType : IReturnType
	{
		...
		public PersistantReturnType(BinaryReader reader, ClassProxyCollection classProxyCollection)
		{
		...
		public PersistantReturnType(ClassProxyCollection classProxyCollection, IReturnType returnType)
		{
			if (returnType == null) {
				classProxyIndex    = - 1;
