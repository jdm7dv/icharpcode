	...
	public class ClassBrowserIconsService : AbstractService
	{
		...
		public int GetIcon(PropertyInfo propertyinfo)
		{
			if (propertyinfo.CanRead && propertyinfo.GetGetMethod() != null) {
				return propertyIndex + GetIcon(propertyinfo.GetGetMethod()) - methodIndex;
			}
			if (propertyinfo.CanWrite && propertyinfo.GetSetMethod() != null) {
				return propertyIndex + GetIcon(propertyinfo.GetSetMethod()) - methodIndex;
			}
			return propertyIndex;
		}
		...
		public int GetIcon(EventInfo eventinfo)
		{
			if (eventinfo.GetAddMethod() != null) {
				return eventIndex + GetIcon(eventinfo.GetAddMethod()) - methodIndex;
			}
			return eventIndex;
		}
