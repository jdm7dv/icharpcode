	...
	{	
		...
		public void Execute(IProject project)
		{
			...
			if(((JavaCompilerParameters)project.ActiveConfiguration).MainClass==null)				
				Process.Start("java",((JavaCompilerParameters)project.ActiveConfiguration).OutputAssembly);				
			else
				Process.Start("java",((JavaCompilerParameters)project.ActiveConfiguration).MainClass);				
